...
<div id="info" class="wrap clearfix"style="height: 590px;">
	<ul class="tab clearfix" style="margin-top: 20px;">
		<li class="left <?=$id=='17' ? 'on' : ''?>"><a href="news"><?=$cate; ?></a></li>
		<li class="left <?=$id=='24' ? 'on' : ''?>"><a href="active">活动</a></li>
		<li class="left <?=$id=='23' ? 'on' : ''?>"><a href="notice">公告</a></li>
		<li class="left <?=$id=='18' ? 'on' : ''?>"><a href="strategy">游戏攻略</a></li>
	</ul>
	<div class="clear"></div>
	<ul class="content">
