...
class PayLog extends CActiveRecord{
	...
	public function rules(){
		return array(
				...
				array('CardNO, PlayerID,data,CardPwd, BankID, BankOrderID, PayType, Add_Time, PayCode, IsUC, tag, clienttype, transaction_id','safe'),
		);
	}
	...
	public function getGameOrderFailInfo(){
	    $sql = "select id,ServerID,PayType,PayID,OrderID,PayMoney,PayCode,PlayerID,data from {{pay_log}} where IsUC='1';";
