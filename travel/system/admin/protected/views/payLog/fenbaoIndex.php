<?php if(Yii::app()->request->isAjaxRequest && Yii::app()->request->isPostRequest) { ?>
	...
	<table class="table table-hover table-striped">
	    ...
	    <tbody>
	        ...
	        <tr>
	            <td><?=$i ?></td>
				<td><?=isset($fenbao[$v->dwFenBaoID]) ? $fenbao[$v->dwFenBaoID] : ''; ?></td>
				<td><?=$v->PayCode; ?></td>
				...
				<td><?=isset($gameServer[$v->game_id][$v->ServerID]) ? $gameServer[$v->game_id][$v->ServerID] : ''; ?></td>
				<td><?=$v->OrderID; ?></td>
       ...
       <?=CHtml::beginForm('', 'POST', array('class'=>
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                        	<select name="dwFenBaoID" class="input-medium">
                                <?php           	
                                	foreach ($fenbao as $k => $v) {
										$selected = (isset($_POST['dwFenBaoID']) && $_POST['dwFenBaoID'] == $k) ? 'selected' :'';
