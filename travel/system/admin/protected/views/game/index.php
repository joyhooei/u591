<?php if(Yii::app()->request->isAjaxRequest && Yii::app()->request->isPostRequest) { ?>
	...
	<p><a href="<?=$this->createUrl('game/add'); ?>" title="新增" class="btn"><i class="icon-plus"></i> 新增</a></p>
	<table class="table table-hover table-striped">
	    ...
	    <tbody>
	        ...
	        <tr>
				...
				<td><?=$v->game_id; ?></td>
				<td><?=$v->game_name; ?></td>
	            <td style="text-align:center"><a data-trigger="confirm" data-content="你确定要删除吗？删除后无法恢复" href="<?=$this->createUrl('game/del/id/'.$v->id); ?>"><i class="icon-remove"></i> 删除</a></td>
	            <td style="text-align:center"><a href="<?=$this->createUrl('game/update/id/'.$v->id); ?>"  title="修改供"><i class="icon-edit"></i> 修改</a></td>
	        </tr>
	       <?php } ?>     
	    </tbody>
	</table>
