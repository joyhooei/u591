	...
	<table class="table table-hover table-striped">
	    ...
	    <tbody>
	        ...
	        <tr>
				...
				<td><?=$v->server_id; ?></td>
				<td><?=$v->server_name; ?></td>
	            <td style="text-align:center"><a data-trigger="confirm" data-content="你确定要删除吗？删除后无法恢复" href="<?=$this->createUrl('gameServer/del/id/'.$v->id); ?>"><i class="icon-remove"></i> 删除</a></td>
	            <td style="text-align:center"><a href="<?=$this->createUrl('gameServer/update/id/'.$v->id); ?>"  title="修改供"><i class="icon-edit"></i> 修改</a></td>
	        </tr>
	       <?php } ?>     
	    </tbody>
	</table>
       ...
       <?=CHtml::beginForm('', 'POST', array('class'=>
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="text" placeholder="区服名称" name="name" value="<?=isset($_POST['name'])  ? $_POST['name'] : '';?>" class="input-small">
        ...
        <p><a href="<?=$this->createUrl('gameServer/add'); ?>" title="新增" class="btn"><i class="icon-plus"></i> 新增</a></p>
