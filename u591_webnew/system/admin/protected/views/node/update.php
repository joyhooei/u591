...
<body>
    <div class="container-fluid">
            <div id="legend" class="">
                <legend class="">修改节点<a href="<?=$_SESSION['nodePid'] ? $this->createUrl('node/index/id/'.$_SESSION['nodePid']) : $this->createUrl('node/index');?>" class="btn" title="查看"><i class="icon-double-angle-left"></i> 返回</a></legend>
            </div>
