        ...
        ?>     
            <table class="table table-hover">
                <tr>
                    ...
                    <td><?=CHtml::activeTextField($model, 'game_id',array('placeholder'=>'输入游戏ID', 'class'=> 'input-xlarge', 'required'=>'required')); ?></td>
                </tr>
                <tr class="controller">
                    <th style="width:130px;line-height:30px;text-align:right"><?=CHtml::activeLabel($model, 'game_name'); ?></th>
                    <td><?=CHtml::activeTextField($model, 'game_name',array('placeholder'=>'输入名称', 'class'=> 'input-xlarge',  'required'=>'required')); ?></td>
                </tr>
