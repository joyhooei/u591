        ...
        ?>     
            <table class="table table-hover">
                <tr>
                    ...
                    <td><?=CHtml::activeTextField($model, 'game_id',array('value'=>8,'placeholder'=>'输入游戏ID', 'class'=> 'input-xlarge', 'required'=>'required')); ?></tr>
                ...
                <tr class="controller">
                    ...
                    <td><?=CHtml::activeTextField($model, 'amount_limit',array('value'=>999,'placeholder'=>'输入限制数量', 'class'=> 'input-xlarge',  'required'=>'required')); ?></td>
                </tr>
