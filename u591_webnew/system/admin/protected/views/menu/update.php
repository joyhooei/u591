    ...
    <div class="container-fluid">
        ...
        <?php echo CHtml::activeHiddenField($model, 'id'); ?>
            <table class="table table-hover">
                <tr>
                    ...
                    <td>
                        <div id="meun_category"> 
                            <?php echo CHtml::activeDropDownList($model, 'm_id', array(), array('class'=>'input-medium meun_grade', 'data-value'=>$model->m_id)) ?>            
                        	<?php echo CHtml::activeDropDownList($model, 'parentid', array(), array('class'=>'input-medium meun_parentid', 'data-value'=>$model->parentid)) ?>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th style="width:130px;line-height:30px;text-align:right">菜单名称</th>
                    <td><?php echo CHtml::activeTextField($model, 'name',array('placeholder'=>'输入分类名称', 'class'=> 'input-xlarge', 'required'=>'required')); ?></td>
                </tr>
                <tr class="controller">
                ...
                <tr>
                    <th style="width:130px;line-height:30px;text-align:right">排序</th>
                    <td><?php echo CHtml::activeTextField($model, 'sort',array('placeholder'=>'输入排序', 'class'=> 'input-xlarge')); ?></td>
                </tr>
