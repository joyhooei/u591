				...
				<?php foreach($info as $v){ ?>
					<tr>
						...
						<td style="text-align:center">
							<?php if($v['type'] == 6) { ?>
								<a data-trigger="confirm" data-content="你确定要禁用吗？禁用后无法恢复" href="<?=$this->createUrl('vgOperators/CancelServiceCommand/id/'.$v['id'].'/serverId/'.$v['serverid'].'/gameId/'.$gameId); ?>"><i class="icon-remove"></i> 禁用</a>
							<?php } ?>
						</td>
					</tr>
				<?php } ?>
...
<?php } else { ?>
	...
	<div class="container-fluid">
		...
		<p>
			<a href="<?=$this->createUrl('vgOperators/bulletinCancel'); ?>" title="取消" class="btn"><i class="icon-remove"></i> 取消公告</a>
			<a href="<?=$this->createUrl('vgOperators/bulletin'); ?>" title="新增" class="btn"><i class="icon-plus"></i> 新增</a>
		</p>
		<div id="tablelist">
		</div>
