        ...
        if($maxLevel == $this->mangerInfo['level']){
            ...
            foreach ($serverIdArr as $serverId){
                ...
                if($conn){
                    ...
                    $sql = "insert into $table(index_id, time_begin, time_end, create_mintime, create_maxtime, level_min, level_max, description, award_type1, award_param1, award_amount1, award_type2, award_param2, award_amount2,  award_type3, award_param3, award_amount3,  award_type4, award_param4, award_amount4, server_id)";
                    $sql .= " values('$indexId', '$beginTime', '$endTime', '$roleBeginTime', '$roleEndTime','$levelMin', '$levelMax', '$message', '$type1', '$param1', '$amount1', '$type2', '$param2', '$amount2', '$type3', '$param3', '$amount3', '$type4', '$param4', '$amount4', '$serverId') ";
