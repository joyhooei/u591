...
write_log(ROOT_PATH."log","api_bind_log_","post=$post, ".date("Y-m-d H:i:s")."\r\n");
...
if($result['status'] == '0'){
	write_log(ROOT_PATH.'log','api_bind_success_',"result=".json_encode($result).date('Y-m-d H:i:s')."\r\n");
}else{
	write_log(ROOT_PATH.'log','api_bind_error_',"{$result['msg']} , ".date('Y-m-d H:i:s')."\r\n");
}
