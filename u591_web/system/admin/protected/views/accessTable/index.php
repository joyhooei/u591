	...
	<table class="table table-hover table-striped">
	    ...
	    <tbody>
	        ...
	        <tr>
				...
				<td><?=$v->title; ?></td>
				<td><?=$v->name; ?></td>
				<td style="text-align:center"><a data-trigger="confirm" data-content="你确定要删除吗？删除后无法恢复" href="<?=$this->createUrl('accessTable/del/id/'.$v->id); ?>"><i class="icon-remove"></i> 删除</a></td>
	            <td style="text-align:center"><a href="<?=$this->createUrl('accessTable/update/id/'.$v->id); ?>"  title="修改供"><i class="icon-edit"></i> 修改</a></td>
	        </tr>
	       <?php } ?>     
	    </tbody>
	</table>
       ...
       <?=CHtml::beginForm('', 'POST', array('class'=>
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="text" placeholder="表名" name="title" value="<?=isset($_POST['title'])  ? $_POST['title'] : '';?>" class="input-small">
        ...
        <p><a href="<?=$this->createUrl('accessTable/add'); ?>" title="新增" class="btn"><i class="icon-plus"></i> 新增</a></p>
