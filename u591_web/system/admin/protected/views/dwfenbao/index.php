	...
	<table class="table table-hover table-striped">
	    ...
	    <tbody>
	        ...
	        <tr>
				<td><?=$v->fenbao_id; ?></td>
				<td><?=$v->name; ?></td>
	            <td style="text-align:center"><a data-trigger="confirm" data-content="你确定要删除吗？删除后无法恢复" href="<?=$this->createUrl('dwfenbao/del/id/'.$v->id); ?>"><i class="icon-remove"></i> 删除</a></td>
	            <td style="text-align:center"><a href="<?=$this->createUrl('dwfenbao/update/id/'.$v->id); ?>"  title="修改"><i class="icon-edit"></i> 修改</a></td>
	        </tr>
	       <?php } ?>     
	    </tbody>
	</table>
...
<body>
       ...
       <?=CHtml::beginForm('', 'POST', array('class'=>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="text" placeholder="分包id" name="fenbaoid" value="<?=isset($_POST['fenbaoid'])  ? $_POST['fenbaoid'] : '';?>" class="input-small">       
        ...
        <p><a href="<?=$this->createUrl('dwfenbao/add'); ?>" title="新增" class="btn"><i class="icon-plus"></i> 新增</a></p>
