...
foreach ($orderInfo as $v){
    ...
    if($status==0 && $quantity>0 && $money){
        ...
        $rpCode = 1;
        $insert_sql = " insert into web_pay_log(CPID,PayCode,ServerID,PayMoney,PayName,Add_Time,rpCode,PayID,OrderID,game_id) values('19','$currency','$server_id','$money','$PayName','$Add_Time','$rpCode','$account_id','$orderId','$game_id') ";
